...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.GET("/email_login_code", middleware.EmailVerificationRateLimit(), middleware.TurnstileCheck(), controller.SendEmailLoginCode)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			userRoute.POST("/login/email_code", middleware.CriticalRateLimit(), middleware.TurnstileCheck(), controller.EmailCodeLogin)
